      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.heroSection}>
          ...
          <View style={styles.quickActionsGrid}>
            {[
              ...
              { title: 'Call Doctor', sub: 'Speak to a physician', icon: 'call', route: 'CallDoctor' },
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  if (action.route) {
                    rootNavigation.navigate(action.route);
                  }
                }}
              >
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.appointmentRow}>
              ...
              <TouchableOpacity
                ...
                onPress={() => rootNavigation.navigate('JoinVideoCall')}
              >
          ...
          <View style={styles.sectionHeaderRow}>
            ...
            <TouchableOpacity onPress={() => rootNavigation.navigate('ReferralDetails')}>
          ...
          <View style={[styles.card, styles.cardLeftBorderWarning]}>
            ...
            <View style={styles.actionRow}>
              <TouchableOpacity
                ...
                onPress={() => rootNavigation.navigate('Appointments')}
              >
              ...
              <TouchableOpacity
                ...
                onPress={() => rootNavigation.navigate('ReferralDetails')}
              >
          ...
          <View style={styles.sectionHeaderRow}>
            ...
            <TouchableOpacity onPress={() => rootNavigation.navigate('Invoice')}>
              <Text style={styles.viewAllText}>View All →</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={[styles.card, styles.cardLeftBorderWarning]}>
            ...
            <View style={styles.actionRow}>
              <TouchableOpacity
                style={styles.warningButton}
                onPress={() => rootNavigation.navigate('Invoice')}
              >
                <Ionicons name="card" size={16} color="#FFFFFF" style={styles.btnIcon} />
          ...
          <View style={styles.sectionHeaderRow}>
            ...
            <TouchableOpacity onPress={() => rootNavigation.navigate('Prescriptions')}>
              <Text style={styles.viewAllText}>View All →</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.prescriptionCard}>
             ...
             <View style={[styles.rowSpaceBetween, {marginTop: 12}]}>
               ...
               <TouchableOpacity style={styles.refillButton} onPress={() => rootNavigation.navigate('Prescriptions')}><Text style={styles.refillButtonText}>Refill Now</Text></TouchableOpacity>
             </View>
          </View>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (item.title === 'Medical Records') {
                  rootNavigation.navigate('MedicalRecords');
                } else if (item.title === 'Physical Therapy') {
                rootNavigation.navigate('PhysicalTherapy');
                } else {
                rootNavigation.navigate('Pharmacy');
                }
              }}
            >
